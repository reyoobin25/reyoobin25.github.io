...
<img src = "/img/batch_jh.png" class="middle-image"/>

그중에서도 ''스프링 배치''를 읽게된 것은 현재 주력으로 사용하고 있는 기술 스택이기 때문에 비교적 최근에 출판된 [스프링 배치 완벽 가이드 2/e](http://www.yes24.com/Product/Goods/99422216) 라는 책을 찾아 읽게되었다. 
...
<img src = "/img/batch_instance.png" class="middle-image"/>

- JobExecution
  - 스프링 배치 잡(Job)의 실제 실행을 의미한다.
  - 잡을 구동할 때마다 매번 새로운 JobExecution 을 얻게된다.

<img src = "/img/batch_execution.png" class="middle-image"/>

- StepExecution
  - 스프링 배치 스텝(Step) 의 실제 실행을 의미한다.

<img src = "/img/batch_stepexe.png" class="middle-image"/>
